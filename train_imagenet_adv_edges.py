...
Maybe we should hook together an FGSM-trained ImageNet model and this model and robustify them end-to-end (no bernoulli loss)?
https://github.com/locuslab/fast_adversarial
https://drive.google.com/drive/folders/1W2zGHyxTPgHhWln1kpHK5h-HY9kwfKfl (this has weights for a model trained against an FGSM eps=4/255 adversary, so we probably want our adversary to do that too).
...
def parse_args():
    ...
    parser.add_argument('--rcf-weights', type=str)
